...
async def seed():
    ...
    claims = [
        ...
        },
        {
            ...
            "diagnosis": "Chronic Gastritis with Endoscopy",
            "icd_codes": ["K29.7"],
            "items": [
                {"description": "Consultation Fee", "icd_code": "K29.7", "amount": 800, "category": "consultation"},
                {"description": "Pantoprazole 40mg x 14", "icd_code": None, "amount": 280, "category": "medication"},
                {"description": "Domperidone 10mg x 21", "icd_code": None, "amount": 105, "category": "medication"},
                {"description": "Upper GI Endoscopy", "icd_code": "K29.7", "amount": 5000, "category": "procedure"},
                {"description": "Room Charges (Private, 1 day)", "icd_code": None, "amount": 6000, "category": "room"},
            ],
            "total_amount": 12185,
            "room_type": "private",
            "status": "flagged",
            "adjudication_notes": "Flagged for manual review. Room rent exceeds cap.",
            "rejection_reason": None,
            "flag_reasons": ["Room rent ₹6000/day exceeds cap ₹4000/day for standard policy. Excess: ₹2000"],
            "approved_amount": 10185,
    ...
    print(f"Created {len(claims)} claims (1 approved, 1 flagged, 1 pending)")
